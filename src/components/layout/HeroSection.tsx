    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-[#2d1b4e] flex flex-col justify-center items-center text-center pt-10 font-pixel">
      ...
      <div className="relative z-20 container mx-auto px-6 flex flex-col items-center">
        <div className="relative w-full max-w-4xl h-[300px] md:h-[450px] translate-y-12 md:translate-y-24 -mb-10">
            ...
            {/* Лівий острів */}
            {/* Виправлено w-70 на w-64 або w-72 (стандартні класи) */}
            <div className="absolute bottom-[1%] left-[10%] md:left-[13%] w-48 md:w-110 h-auto aspect-square">
                 <Image 
            ...
            {/* Правий острів */}
            <div className="absolute bottom-[2%] right-[5%] md:right-[3%] w-56 md:w-130 h-auto aspect-square">
                <Image 
            ...
            {/* Персонаж */}
            {/* Опустив персонажа трохи нижче (bottom-[25%]), щоб він краще "сидів" між опущеними островами */}
            <div className="absolute bottom-[73%] left-1/2 -translate-x-1/2 w-24 md:w-48 aspect-square z-50">
                <Image 
        ...
        <Link href="/signup">
          <button 
            className="
              ...
              text-white text-2xl md:text-3xl font-bold tracking-widest uppercase
